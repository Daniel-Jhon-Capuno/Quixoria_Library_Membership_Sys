    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div class="space-y-4">
            <div class="rounded-xl p-6 shadow-card"
                ...
                <div class="space-y-3">
                    <a href="{{ route('staff.borrow-requests.index') }}" class="block w-full px-4 py-2 bg-primary hover:bg-primary-dark rounded-lg text-white font-medium transition text-center text-sm">View All Requests</a>
                    <button class="block w-full px-4 py-2 bg-accent hover:bg-blue-600 rounded-lg text-white font-medium transition text-center text-sm" onclick="document.querySelector('[data-overdue-list]').scrollIntoView({behavior: 'smooth'})">Overdue List</button>
                    <a href="{{ route('admin.users.index') }}" class="block w-full px-4 py-2 bg-secondary hover:bg-cyan-500 rounded-lg text-white font-medium transition text-center text-sm">Member Search</a>
                </div>
            </div>
        </div>
    </div>
